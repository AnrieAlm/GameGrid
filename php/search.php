...
$dbname = 'game_grid'; // Your dagtabase name
$username = 'game_grid'; // Your database username
$password = 'game_grid'; // Your database password
...
<body>
    ...
    <form class="search-form" method="GET" action="search.php">
        <input type="text" name="query" placeholder="Enter game title..." value="<?= htmlspecialchars($searchQuery) ?>" required>
